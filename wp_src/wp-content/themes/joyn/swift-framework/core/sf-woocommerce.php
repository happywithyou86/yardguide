            ...
            <li class="parent shopping-bag-item">
                ...
                <?php if ( $show_cart_count ) { ?>
                    ...
                    <a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>"
                       ...
                       <?php echo apply_filters( 'sf_header_cart_icon', '<i class="ss-cart"></i>' ); ?><?php echo $woocommerce->cart->get_cart_total(); ?><span class="count">
                        (<?php echo $cart_count; ?>)</span><span
                            class="num-items"><?php echo $cart_count_text_alt; ?></span></a>

                <?php } else { ?>

                    <a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>"
                       title="<?php _e( 'View your shopping cart', 'swiftframework' ); ?>"><?php echo apply_filters( 'sf_header_cart_icon', '<i class="ss-cart"></i>' ); ?><?php echo $woocommerce->cart->get_cart_total(); ?><span
                            class="num-items"><?php echo $cart_count_text_alt; ?></span></a>
    ...
    if ( ! function_exists( 'sf_wishlist_button' ) ) {
        function sf_wishlist_button() {
            ...
            if ( class_exists( 'YITH_WCWL_UI' ) ) {
                ...
                $html .= '><a href="' . htmlspecialchars( $yith_wcwl->get_addtowishlist_url() ) . '" data-product-id="' . $product->id . '" data-product-type="' . $product_type . '" ' . $classes . ' >';
