				...
				$this->sections[] = array(
					...
					'fields' => array(
						...
						array(
							...
							'desc' => '',
							'default' => "Contact us on 0800 123 4567 or info@joyn.com"
							),
						array(
							'id' => 'tb_right_config',
							'type' => 'select',
						...
						array(
							...
							'desc' => '',
							'options' => array(
								'header-4' => array('title' => '', 'img' => $template_directory.'/images/Joyn_header_image_1.png'),
								'header-6' => array('title' => '', 'img' => $template_directory.'/images/Joyn_header_image_2.png'),
								'header-7' => array('title' => '', 'img' => $template_directory.'/images/Joyn_header_image_3.png'),
								'header-8' => array('title' => '', 'img' => $template_directory.'/images/Joyn_header_image_4.png'),
								'header-vert' => array('title' => '', 'img' => $template_directory.'/images/Joyn_header_image_5.png'),
								'header-vert-right' => array('title' => '', 'img' => $template_directory.'/images/Joyn_header_image_6.png')
							),
							'default' => 'header-4'
							),
						array(
						...
						array(
						    ...
						    'subtitle' => "Choose the config for the left header area if you are using Header 2, or 4. You can drag the items between enabled/disabled and also order them as you like.",
						    'compiler'  => 'true',
						    'options'   => array(
						        'enabled'   => array(
						        	'text'	=> 'Text/Shortcode',
...
//						    ),
						...
						array(
							'id' => 'show_sub',
							'type' => 'button_set',
							'title' => __('AUX Links - Subscribe', 'swift-framework-admin'), 
						...
						array(
							...
							'title' => __('AUX Links - Subscribe form code', 'swift-framework-admin'),
						...
						array(
							'id' => 'show_translation',
							'type' => 'button_set',
							'title' => __('AUX Links - Translation', 'swift-framework-admin'), 
						...
						array(
							'id' => 'show_account',
							'type' => 'button_set',
							'title' => __('AUX Links - Account', 'swift-framework-admin'), 
						...
						array(
							'id' => 'show_cart',
							'type' => 'button_set',
							'title' => __('AUX Links - Cart', 'swift-framework-admin'), 
						...
						array(
							'id' => 'show_wishlist',
							'type' => 'button_set',
							'title' => __('AUX Links - Wishlist', 'swift-framework-admin'), 
						...
						array(
							...
							'desc' => '',
							'default' => "&copy;[the-year] Joyn &middot; Built with love by <a href='http://www.swiftideas.net'>Swift Ideas</a> using [wp-link]."
							),	
						),
					);
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'color'=>false,
						'letter-spacing'=>true,
						'output' => array('#main-nav, #header nav, #vertical-nav nav, .header-9#header-section #main-nav, #overlay-menu nav, #mobile-menu, #one-page-nav li .hover-caption, .mobile-search-form input[type="text"]'), // An array of CSS selectors to apply this font style to dynamically
						'compiler' => array('#main-nav, #header nav,#vertical-nav nav, .header-9#header-section #main-nav, #overlay-menu nav, #mobile-menu, #one-page-nav li .hover-caption, .mobile-search-form input[type="text"]'), // An array of CSS selectors to apply this font style to dynamically
						'units'=> 'px', // Defaults to px
						'default' => array(
							'font-size'=>'18px',
							'font-family'=>'Source Sans Pro',
			...
			$this->sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'desc' => '',
						'default' => 'Creating an account with Joyn is quick and easy, and will allow you to move through our checkout quicker. You can also store multiple shipping addresses, gain access to your order history, and much more.'
						),
					array(
						'id' => 'help_bar_text',
						'type' => 'text',
...
//			}
		...
		public function setArguments() {
			...
			$this->args = array(
				...
				'opt_name'          	=> 'sf_joyn_options', // This is where your data is stored in the database and also becomes your global variable name.
