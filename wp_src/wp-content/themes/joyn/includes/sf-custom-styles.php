    ...
    if ( ! function_exists( 'sf_custom_styles' ) ) {
        function sf_custom_styles() {
            ...
            if ( $resize_header_height != "" ) {
            	...
            	echo '.full-center.resized-header #main-navigation ul.menu > li > a, .full-center.resized-header .header-right ul.menu > li > a, .full-center.resized-header nav.float-alt-menu ul.menu > li > a, .full-center.resized-header .header-right div.text {height:' . $resize_header_height . ';line-height:' . $resize_header_height . ';}';
            	...
            	echo '.full-center.resized-header nav li.menu-item.sf-mega-menu > ul.sub-menu, .full-center.resized-header nav li.menu-item.sf-mega-menu-alt > ul.sub-menu, .full-center.resized-header .ajax-search-wrap {top:' . $resize_header_height . '!important;}';
            ...
            echo '.article-share label {background-color: ' . $share_button_bg . '!important; color: ' . $share_button_text . '!important;}';
            ...
            echo '.woocommerce a.button:hover, .woocommerce .coupon input.apply-coupon:hover, .woocommerce .shipping-calculator-form .update-totals-button button:hover, .woocommerce .quantity .plus:hover, .woocommerce .quantity .minus:hover, .add_review a:hover, .woocommerce #review_form #respond .form-submit input:hover, .lost_reset_password p.form-row input[type="submit"]:hover, .track_order p.form-row input[type="submit"]:hover, .change_password_form p input[type="submit"]:hover, .woocommerce table.my_account_orders .order-actions .button:hover, .woocommerce .widget_price_filter .price_slider_amount .button:hover, .woocommerce.widget .buttons a:hover, .woocommerce .wishlist_table tr td.product-add-to-cart a:hover, .woocommerce input.button[name="save_address"]:hover, .woocommerce input[name="apply_coupon"]:hover, .woocommerce form.register input[type="submit"]:hover, .woocommerce form.cart .yith-wcwl-add-to-wishlist a:hover, .load-more-btn:hover, #wew-submit-email-to-notify:hover, .woocommerce input[name="save_account_details"]:hover {background: '.$accent_color.'; color: '.$accent_alt_color.';}';
            echo '.woocommerce form.cart button.single_add_to_cart_button:hover {background: '.$accent_color.'!important; color: '.$accent_alt_color.'!important;}';
            ...
            echo '.woocommerce input[name="apply_coupon"] {background: ' . $alt_bg_color . '!important; color: ' . $secondary_accent_color . '!important}';
            echo '.woocommerce input[name="apply_coupon"]:hover {background: ' . $accent_color . '!important; color: ' . $accent_alt_color . '!important;}';
