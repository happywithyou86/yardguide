...
( function( $ ){
	...
	wp.customize('sf_customizer[header_bg_color]',function( value ) {
		value.bind(function(to) {
			$('.header-wrap, .vertical-header .header-wrap #header-section, .ajax-search-wrap').css('background-color', to ? to : '' );
		});
	});
	...
	wp.customize('sf_customizer[header_border_color]',function( value ) {
		value.bind(function(to) {
			$('.header-wrap, #header-section .is-sticky .sticky-header, #header-section.header-5 #header, .vertical-header .header-wrap, .vertical-header-right .header-wrap').css('border-color', to ? to : '' );
		});
	});
